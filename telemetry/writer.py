...
from telemetry import metrics, store
...
async def _h_roll(con, ev):
    ...
    # Per-face counters from dice_after
    dice_after = ev.get("dice_after") or []
    if dice_after:
        pass  # already captured via Prometheus; per-face DB counts come from JSON view
