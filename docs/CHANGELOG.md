...
- _Behind the scenes: we're getting smarter about how every game plays out, so we
  can keep your nights out more fun, fair, and worth the round you just lost._
...
- A friendlier loading screen now keeps you company while things connect — no more
...
- _Behind the scenes: we're tuning the game's foundations so everything stays fast
  and fair, no matter how loud the bar gets._
