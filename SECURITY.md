...
report. The notes below are about setting honest expectations.
...
report tips off attackers before there's a fix. Report it privately instead:
...
- If I can reproduce it and agree it's a real issue, I'll fix it on `main` and
  deploy. How fast depends on how bad it is and how much free time I have.
