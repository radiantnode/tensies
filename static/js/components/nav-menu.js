  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      ...
      <nav class="menu-panel" aria-label="Menu">
        ...
        <p class="menu-legal"><a href="https://simmonstx.com/terms/" target="_blank" rel="noopener noreferrer">Terms</a> &middot; <a href="https://simmonstx.com/privacy/" target="_blank" rel="noopener noreferrer">Privacy policy</a></p>
      </nav>
      <div class="menu-foot">
